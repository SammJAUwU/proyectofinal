...
if (isset($_GET["searchP"])) {
    $_SESSION["prod"] = $_GET["searchP"];
}

$searchProducto = $_SESSION["prod"];
...
$queryProductos = "SELECT * FROM productos WHERE nombre_producto = '$searchProducto'";
...
$traerProductos = mysqli_fetch_assoc($sqlProductos);
...
<body>
    ...
    <div class="container mt-4">
        ...
        if (mysqli_num_rows($sqlProductos) > 0) {
        ?>
            <h2 class="titulo display-1 text-uppercase my-5 text-center" style="font-size: 40px;"><?php echo $searchProducto; ?></h2>
        <?php
        } else {
                ...
                <div class="card h-100">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <h5 class="card-title text-center"><?php echo $nombreProducto; ?></h5>
                            <div class="text-center mb-3">
                                <span class="text-body-secondary text-center"><b>Precio: </b><?php echo '$' . $precioProducto; ?></span>
                            </div>
                        </div>
                        <div class="col-md-6 text-center">
                            <div class="card-body">
                                <h5 class="card-title text-center fw-bold" style="font-size: 32px;"><?php echo $nombreProducto; ?></h5>
                                <p class="card-text" style="font-size: 28px;"><?php echo $descripcionProducto; ?></p>
                                <form method="post">
                                    <div class="mb-3">
                                        <?php
